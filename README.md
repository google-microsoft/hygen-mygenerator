...
`$ hygen-add https://github.com/google-microsoft/hygen-mygenerator`
...
## create inject or sh template 
```shell script

hygen mygenerator create:inject --name mygenerator

hygen mygenerator create:sh --name mygenerator
